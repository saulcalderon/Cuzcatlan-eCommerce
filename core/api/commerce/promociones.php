...
require_once('../../models/commerce/promociones.php');
...
if (isset($_GET['action'])) {
    ...
    if (/*isset($_SESSION['id_usuario'])*/1) {
        ...
        switch ($_GET['action']) {
            case 'readAll':
                if ($promociones->setIdCategoria(/*$_POST['id_cliente']*/1)) {
                    if ($result['dataset'] = $promociones->readAllProductos()) {
